...
<html lang="en">
  ...
  <?php foreach ($array as $array){
      ...
      <div class="navbar">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <span class="loo">
              <a href="https://iimcat.ac.in/per/g01/pub/756/ASM/WebPortal/1/index.html?756@@1@@1"
                target="_blank">CAT</a>
            </span>
    ...
    <div class="start_page">
      <img src="./images/B-M-S-COLLEGE-OF-ENGINEERING-BASAVANAGUDI-1024x596.png"
        alt="B-M-S-COLLEGE-OF-ENGINEERING-BASAVANAGUDI" class="img1">
      <p class="para">
    ...
    <div id="notification" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div class="exam_notification">
        <p1>1. GATE EXAM ARE SCHEDULED TO TAKE PLACE ON 5, 6, 12, 13 Feb 2022 <a href="https://gate.iitkgp.ac.in/"
            target="_blank" style="text-decoration: none;">click here to visit official GATE website</a>
        </p1>
        <p1>2.
        ...
        <P1>5. CAT EXAMS ARE SCHEDULED TO TAKE PLACE ON Sun, 28 Nov, 2021 <a
            href="https://iimcat.ac.in/per/g01/pub/756/ASM/WebPortal/1/index.html?756@@1@@1" target="_blank"
            style="text-decoration: none;">click here to visit official GATE website</a>
        </P1>
        <P1>6. <a href="https://cdn.digialm.com//EForms/configuredHtml/756/66504/login.html" target="_blank"
            style="text-decoration: none;">click here</a>TO DOWNLOAD CAT 2020 SCORE CARD
        </P1>
      </div>
    </div>
    ...
    <div id="bms_notification" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div class="bms_notification">
        ...
        <p1>
          ...
          <a href="https://bmsce.ac.in/website_notifications/First_Year_B_E__Inauguration_Invitation.pdf"
            target="_blank" style="text-decoration: none;">More info</a>
        </p1>
        <p1>
          <span style="color: rgb(255, 0, 0);">3.</span> Commencement of First Year B.E. (2021-2022) Program - Monday
          13th December 2021
          <a href="https://bmsce.ac.in/website_notifications/Commencement_of_first_year_classes.pdf" download
            style="text-decoration: none;" target="_blank">Click here
          </a> to download TT.
        </p1>
        <p1>
          ...
          <a href="https://bmsce.ac.in/website_notifications/Rescheduled_Circular_for_Change_of_Branch.pdf"
            target="_blank" style="text-decoration: none;">notification
          </a>
        </p1>
        <p1>
          <span style="color: rgb(255, 0, 0);">5.</span> AICTE Swanath Scholarship Scheme (Both Degree and Diploma
          Level) <a href="https://bmsce.ac.in/website_notifications/AICTE_Swanath_Scholarship_Scheme.pdf"
            target="_blank" style="text-decoration: none;">More info
          </a>
        </p1>
        <p1>
        ...
        <p1>
          ...
          <a href="https://bmsce.ac.in/CalendarEvents/Calendar%20of%20Events%20for%20UG%20Higher%20Semesters%20for%20the%20academic%20year%202021-22.pdf"
            target="_blank" style="text-decoration: none;">More info
          </a>
        </p1>
      </div>
